   ...
   // parametes: used to tale imnput
    ...
    stages {
        ...
        stage('Deploy to dev env') {
            ...
            steps {
                script {
                    // ✅ FIX 1: changed DOCKER_REPO_NAME to JFROG_DOCKER_REPO_NAME
...
def dockerBuildandPush() {
    return {
        ...
        // ✅ FIX 3: removed space in ${env.JFROG_DOCKER_REPO_NAME }
...
def imagevalidation() {
    return {
        ...
        try {
            // ✅ FIX 2: changed DOCKER_REPO_NAME to JFROG_DOCKER_REPO_NAME
            ...
            println ("***** docker image not available in registry, building and pushing now ***")
            dockerBuildandPush().call()
        }
    }
}
